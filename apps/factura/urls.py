...
urlpatterns = [
    ...
    path('negocio/<int:negocio_id>/', DetailNegocio.as_view(), name='detalle_negocio'),
    ...
    path('negocio/<int:negocio_id>/productos/', InicioProductos.as_view(), name='inicio_productos'),
    path('negocio/<int:negocio_id>/crear_producto/', CrearProducto.as_view(), name='crear_producto'),

    path('negocio/<int:negocio_id>/crear_factura/', CrearFactura.as_view(), name='crear_factura'),
    path('negocio/ver_factura/<int:factura_id>/', VerFactura.as_view(), name='ver_factura'),
    path('negocio/ver_factura/<int:factura_id>/pdf/', generar_pdf, name='generar_pdf'),
